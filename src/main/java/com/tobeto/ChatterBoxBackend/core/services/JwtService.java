...
public class JwtService {
    @Value("${jwt.key}")
    private String SECRET; // app properties
    ...
    public String generateToken(UserDetails user){
        return Jwts
                ...
                .signWith(getSigninKey(), SignatureAlgorithm.HS256) // bu değerle imzala!!! benim ürettiğim imzası
                .compact();
    }
    ...
    public Key getSigninKey(){ // ayrı kılan kendine has key!!!!!!!! her uygulamada farklı!!!
